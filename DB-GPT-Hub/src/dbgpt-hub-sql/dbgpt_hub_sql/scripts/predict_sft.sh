...
CUDA_VISIBLE_DEVICES=0  python dbgpt_hub_sql/predict/predict.py \
    ...
    --checkpoint_dir dbgpt_hub_sql/output/adapter/Qwen2.5-Coder-7B-text2sql-qlora-4bit-1024 \
    --predicted_out_filename dbgpt_hub_sql/output/pred/pred_qwen25_text2sql.sql >> ${pred_log}
