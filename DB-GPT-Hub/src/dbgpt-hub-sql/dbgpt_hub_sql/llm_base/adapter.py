...
def init_adapter(
    ...
    if finetuning_args.finetuning_type == "lora":
        ...
        if model_args.checkpoint_dir is not None:
            ...
            # )
            weight_bin = os.path.join(model_args.checkpoint_dir[0], WEIGHTS_NAME)  # adapter_model.bin
            weight_safe = os.path.join(model_args.checkpoint_dir[0], "adapter_model.safetensors")

            assert os.path.exists(weight_bin) or os.path.exists(weight_safe), \
